...
2026-07-18時点で、登録済み期待値のうち3ケースは最終レビュー未実施となる。
...
SEL-073からSEL-075のSQLはA5:SQL Mk-2 2.21.2の`Ctrl+Q`で実整形している。
...
```powershell
powershell -ExecutionPolicy Bypass -File tools/Set-ManualOutputCase.ps1 -CaseId SEL-075
```
